...
After matching the transactions against the business’s own records, the administrator can 
...
## Configuration
[How to set up and run the Vendor Reconciliation module](Vendor Recon/ConfigureVendorRecon.md)
